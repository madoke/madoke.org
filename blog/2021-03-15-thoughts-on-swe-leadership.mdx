...
import ItsatrapImage from "./img/itsatrap.gif"

<ImageWithAttribution
  src={ItsatrapImage}
  sourceName={'Giphy'}
  authorName={'@starwars'}
  imageName={"It's a Trap"}
  imageUrl={'https://giphy.com/gifs/starwars-movie-star-wars-3ornka9rAaKRA2Rkac'}/>
...
import MentoringImage from "./img/mentoring.jpg"

<ImageWithAttribution
  src={MentoringImage}
  sourceName={'Unsplash'}
  authorName={'Nadir sYzYgY'}
  imageName={"Mentoring"}
  imageUrl={'https://unsplash.com/photos/den6gTowZKs'}/>
