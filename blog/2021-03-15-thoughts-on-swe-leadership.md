...
* The error was caused by something outside the team domain: Another commons situation in micro service architectures. In these kind of situations, it is very important that you or a senior team member reach out to the other team responsible for this service, and do the root cause analysis, develop an action plan that can potentially involve both teams.
